		...
		if ( $which === 'top' ) {
            ...
            <select name="state" id="state">
                ...
                <option value="<?php esc_attr_e( Common::STATE_PIXEL_ASSIGNED ); ?>" <?php selected( $state, Common::STATE_PIXEL_ASSIGNED ); ?>>
					<?php echo esc_html( List_Table_Pixels::get_state_label( true, true, false ) ) ?>
                </option>
